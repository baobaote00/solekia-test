...
public class StudentRequest implements Serializable {
   ...
   * 性的（1:male、2:female）
   */
  @NotNull(message = "性的を空欄にすることはできません")
   ...
   * 年齢
   */
  @NotNull(message = "年齢を空欄にすることはできません")
  ...
  private List<MstClass> className;

  public boolean getContant(Long classID){
    for (MstClass studentRequests : className) {
      if (studentRequests.getClassId() == classID) {
        return true;
      }
    }
    return false;
